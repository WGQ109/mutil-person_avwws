...
class ResNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.layer1 = ResNetLayer(16, 16, stride=1)
        self.layer2 = ResNetLayer(16, 32, stride=2)
        self.layer3 = ResNetLayer(32, 64, stride=2)
        self.layer4 = ResNetLayer(64, 128, stride=2)
...
class visualFrontend(nn.Module):
    ...
    def forward(self, inputBatch):
        ...
        outputBatch = outputBatch.reshape(batchsize, -1, 128)
...
if __name__ == '__main__':
    ...
    A = np.random.rand(1,125,112,112)
    A = torch.from_numpy(A)
    A = A.float()
    xxx = visualFrontend()

    from thop import profile
    flops, params = profile(xxx, [A])
