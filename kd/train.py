...
def main():
    ...
    while(1):
        trainingLoss,trainingAcc = train_network(teacher_model,model,dset_loaders['train'],optim,device)
        ...
        if ((epoch % 2 == 0) or (epoch == 1000)) and (epoch != 0) and epoch>0:
