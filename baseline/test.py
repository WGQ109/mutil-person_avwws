...
PATH = r'D:\get\20220316-3talk\checkpoints\models\train-step_0076-loss_0.652.pt'
dsets = {x: MyDataSet(x, audio_path, video_path) for x in ['train', 'val']}
dset_loaders = {x: torch.utils.data.DataLoader(dsets[x], batch_size=4, shuffle=True, num_workers=0,
