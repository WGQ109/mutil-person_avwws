...
PATH = r'D:\get\20220429-1talk\checkpoints\models\train-step_0082-loss_0.864.pt'
dsets = {x: MyDataSet(x, audio_path, video_path) for x in ['train', 'val']}
dset_loaders = {x: torch.utils.data.DataLoader(dsets[x], batch_size=2, shuffle=False, num_workers=0,drop_last=True,
